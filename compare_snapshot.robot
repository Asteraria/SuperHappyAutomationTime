...
Profile the devices
    Profile the system for "config" on devices "R1;R2" as "./backups/new_snapshot"

Compare snapshots
    Compare profile "./backups/good_snapshot" with "./backups/new_snapshot" on devices "R1;R2"
